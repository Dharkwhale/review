...
import activitiesimg from '../Images/activitiesimg.png'
import { FaMapMarkerAlt, FaStar, FaBed, FaChevronUp, FaChevronDown } from "react-icons/fa";
...
const TripActivities = () => {
  return (
    ...
    <div className='bg-white rounded-xl shadow-lg flex text-sm'>
      <div >
        <img src={activitiesimg} alt="Activities" className="h-50 p-4" />
      </div>
      <div className='flex flex-col'>
        <div className='flex'>
        <div>
          <p className='pt-3 font-bold text-lg'>The Museum Of Morder Art</p>
          <p className='font-semibold'> Works from Van Gogh and Warhol & beyond plus a sculpture <br></br> garden, 2 cafes & The mordern restaurant</p>
        </div>
