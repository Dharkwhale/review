        ...
        <div className=' bg-white rounded-xl shadow-lg'>
          <div className='flex justify-between items-stretch'>
            ...
            <div className='flex flex-col w-full'>
              <div className='pl-9 pb-9 pt-9 flex items-center space-x-1'>
            ...
            {/* facilities */}
            <div className=' flex flex-grow items-center  w-full border border-s pt-2 pl-6 pb-2 gap-x-2'>
              <p className='flex  items-center gap-x-2'>Facilities:</p>
              <MdLuggage className='flex flex-col' />
              <span className='text-[12px] pr-2'>Baggage: 20kg, Cabin Baggage: 8kg</span>
              <TfiVideoClapper />
              <span className='text-[12px] pr-2'>in flight entertainment</span>
              <TbToolsKitchen2 />
              <span className='text-[12px] pr-2'> In flight meal</span>
              <PiUsbDuotone />
              <span className='text-[12px] pr-2'>USB Port</span>
            </div>
            {/* flight, price, edit */}
            <div className="flex justify-between items-center px-2 pt-2 pb-2">
